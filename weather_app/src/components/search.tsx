...
function Search() {
  ...
  return (
    <form action="" onSubmit={handleSubmit} className="w-fit h-fit">
      <div id="search-00" className="w-85 h-13 flex flex-row justify-center relative md:w-144.5 lg:w-30 lg:h-13.5">
        <input 
          type="text" id="search" value={input} onChange={(e)=>setInput(e.target.value)} 
          placeholder="Search city..." className="h-13 w-fit md:w-131 md:h-17
