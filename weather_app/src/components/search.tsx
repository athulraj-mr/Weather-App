...
function Search() {
    return (
        <div id='search-bar' className='flex flex-row items-center gap-2.5 
            w-85.25 h-13.5 rounded-[25px] px-5 py-2.5 bg-[#C2D4D3] opacity-100'>
            <div id='frame-1' className='flex flex-row items-center gap-6.25 w-fit h-fit opacity-100'>
              ...
              <span id='search-text' className='w-24.5 h-9 text-[#7E7C7C]
                   text-4 leading-9 font-normal opacity-100'>
                Search city...
              </span>
            </div>
        </div>
