        ...
        <div id='main-info' className='flex flex-col w-fit h-fit gap-12.25 md:items-center lg:gap-7'>
            <div id='main-info-in' className='flex flex-col w-fit h-fit gap-5 justify-center items-center md:gap-8 lg:gap-7'>
              ...
              <div id='main-info-inner' className=' flex flex-row md:h-fit lg:w-51.25 lg:h-9 lg:justify-center'>
                <span className='font-bold text-7xl text-[#FFFFFF] text-center md:text-8xl md:leading-8 lg:text-5xl lg:leading-9'>30<sup className='top-[-0.25em]'>°C</sup></span>
              </div>
            </div>
            <div id='frame-2' className='flex flex-row justify-between w-70 h-fit 
              ...
              <span className='text-[20px] h-7 text-[#ffffff] font-normal md:text-2xl md:h-9 lg:w-40 lg:h-9 lg:text-[20px] lg:leading-5'>Kuala Lumpur</span>
              <span className='text-[20px] h-7 text-[#ffffff] font-normal text-right md:text-2xl md:h-9 lg:w-24 lg:h-9 lg:text-[20px] lg:leading-5'>Monday</span>
            </div>
        </div>
    )
}
