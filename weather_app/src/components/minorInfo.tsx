    ...
    return (
      <div id='minor-info' className='flex flex-col w-70 h-fit md:gap-3 md:w-90.5 lg:w-[263px] lg:gap-2'>
          <div id='frame-8' className='flex flex-row w-fit h-fit gap-2.5 md:gap-5 items-center'>
            ...
            <span className='w-fit h-9 text-[15px] font-medium leading-9 text-[#FFFFFF] md:text-[18px] lg:text-[16px]'>Light Rain</span>
          </div>
          <div id='frame-9' className='flex flex-row w-fit h-fit gap-2.5 md:gap-5 items-center'>
            ...
            <span className='w-fit h-9 font-medium text-[15px] leading-9 text-[#FFFFFF] md:text-[18px] lg:text-[16px]'>Min Temperature - 28°C</span>
          </div>
          <div id='frame-10' className='flex flex-row w-fit h-fit gap-2.5 md:gap-5 items-center'>
            ...
            <span className='w-fit h-9 font-medium text-[15px] leading-9 text-[#ffffff] md:text-[18px] lg:text-[16px]'>Max Temperature - 31°C</span>
          </div>
      </div>
    )
}
