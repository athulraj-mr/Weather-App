...
function TodayCard() {
    return (
        <div id="todaycard" className="flex flex-col w-67 h-55.25 rounded-[20px] justify-center top-3.75
            right-5 bottom-3.75 left-5 gap-2.5 bg-[#252222A6] shadow-[2px_4px_5px_0px_#00000040] md:w-92.5 md:pl-4 md:mt-4">
            <div id="air" className="w-fit mt-5 lg:w-32.75 h-9 flex flex-row items-center ml-5 md:ml-3.5">
                <span className="font-medium text-[17px] leading-4.25 text-[#FFFFFF] md:text-[20px]">Air Quality Index</span>
            </div>
            <div id="frame-26" className="flex flex-row w-57 h-36.25 gap-2.5 ml-5 items-end md:w-76 md:ml-3.5">
                ...
                <div className="w-17.5 h-36.25 flex items-end justify-center md:justify-end md:w-41.5">
